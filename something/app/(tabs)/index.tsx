...
const PATIENTS = [
  { id: '1', name: 'John Doe', patientId: 'P-8832', age: 54, gender: 'Male', status: 'stable', pillsAlert: false },
  { id: '2', name: 'Jane Smith', patientId: 'P-7721', age: 67, gender: 'Female', status: 'attention', pillsAlert: true },
  { id: '3', name: 'Bob Lee', patientId: 'P-9012', age: 45, gender: 'Male', status: 'stable', pillsAlert: false },
  { id: '4', name: 'Maria Garcia', patientId: 'P-8102', age: 72, gender: 'Female', status: 'attention', pillsAlert: true },
];
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.searchWrapper}>
          ...
          <TextInput placeholder="Search patients..." placeholderTextColor="#C7C7CC" style={styles.searchInput} />
        </View>

        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Patients</Text>
          <View style={styles.countBadge}><Text style={styles.countBadgeText}>{PATIENTS.length} Total</Text></View>
        </View>

        <View style={styles.patientsList}>
          {PATIENTS.map((p) => (
            <TouchableOpacity key={p.id} style={styles.patientCard} activeOpacity={0.75} onPress={() => router.push('/patient-profile' as any)}>
